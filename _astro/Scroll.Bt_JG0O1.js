...
let j = (h = {}) => {
    ...
    return t.setKey = function(e, s) {
        let i = t.value;
        typeof s > "u" && e in t.value ? (t.value = {
            ...t.value
        }, delete t.value[e], t.notify(i, e)) : t.value[e] !== s && (t.value = {
            ...t.value,
            [e]: s
        }, t.notify(i, e))
    }, t
...
class G {
    ...
    advance(t) {
        ...
        if (this.duration && this.easing) {
            ...
            s = i >= 1;
            const l = s ? 1 : this.easing(i);
            this.value = this.from + (this.to - this.from) * l
        } else this.lerp ? (this.value = function(l, o, r, a) {
            return function(c, d, u) {
                return (1 - u) * c + u * d
            }(l, o, 1 - Math.exp(-r * a))
        }(this.value, this.to, 60 * this.lerp, t), Math.round(this.value) === this.to && (this.value = this.to, s = !0)) : (this.value = this.to, s = !0);
        s && this.stop(), (e = this.onUpdate) === null || e === void 0 || e.call(this, this.value, s)
    }
    stop() {
        this.isRunning = !1
    }
    fromTo(t, e, {
        ...
        this.from = this.value = t, this.to = e, this.lerp = s, this.duration = i, this.easing = l, this.currentTime = 0, this.isRunning = !0, o?.(), this.onUpdate = r
    }
}
class J {
    constructor({
        ...
        }, this.wrapper = t, this.content = e, s && (this.debouncedResize = function(o, r) {
            let a;
            return function() {
                let n = arguments,
                    c = this;
...
class V {
    ...
    emit(t, ...e) {
        let s = this.events[t] || [];
        for (let i = 0, l = s.length; i < l; i++) s[i](...e)
    }
    on(t, e) {
        var s;
        return !((s = this.events[t]) === null || s === void 0) && s.push(e) || (this.events[t] = [e]), () => {
            var i;
            this.events[t] = (i = this.events[t]) === null || i === void 0 ? void 0 : i.filter(l => e !== l)
        }
    }
    off(t, e) {
        var s;
        this.events[t] = (s = this.events[t]) === null || s === void 0 ? void 0 : s.filter(i => e !== i)
    }
    destroy() {
        this.events = {}
    }
...
class Q {
    constructor(t, {
        ...
        this.lastDelta = {
            x: 0,
            y: 0
        }, this.windowWidth = 0, this.windowHeight = 0, this.onTouchStart = i => {
            const {
                clientX: l,
                clientY: o
            } = i.targetTouches ? i.targetTouches[0] : i;
            this.touchStart.x = l, this.touchStart.y = o, this.lastDelta = {
                x: 0,
                y: 0
            ...
            const {
                clientX: n,
                clientY: c
            } = i.targetTouches ? i.targetTouches[0] : i, d = -(n - ((o = (l = this.touchStart) === null || l === void 0 ? void 0 : l.x) !== null && o !== void 0 ? o : 0)) * this.touchMultiplier, u = -(c - ((a = (r = this.touchStart) === null || r === void 0 ? void 0 : r.y) !== null && a !== void 0 ? a : 0)) * this.touchMultiplier;
            this.touchStart.x = n, this.touchStart.y = c, this.lastDelta = {
                x: d,
                y: u
            }, this.emitter.emit("scroll", {
                deltaX: d,
            ...
            l *= r === 1 ? F : r === 2 ? this.windowWidth : 1, o *= r === 1 ? F : r === 2 ? this.windowHeight : 1, l *= this.wheelMultiplier, o *= this.wheelMultiplier, this.emitter.emit("scroll", {
                deltaX: l,
                deltaY: o,
                event: i
            })
        ...
        }, this.element = t, this.wheelMultiplier = e, this.touchMultiplier = s, this.touchStart = {
            x: null,
            y: null
        }, this.emitter = new V, window.addEventListener("resize", this.onWindowResize, !1), this.onWindowResize(), this.element.addEventListener("wheel", this.onWheel, {
            passive: !1
...
class Z {
    constructor({
        ...
        duration: n,
        easing: c = f => Math.min(1, 1.001 - Math.pow(2, -10 * f)),
        lerp: d = .1,
        infinite: u = !1,
        ...
        this.__isScrolling = !1, this.__isStopped = !1, this.__isLocked = !1, this.userData = {}, this.lastVelocity = 0, this.velocity = 0, this.direction = 0, this.onPointerDown = f => {
            f.button === 1 && this.reset()
        }, this.onVirtualScroll = f => {
            if (typeof this.options.virtualScroll == "function" && this.options.virtualScroll(f) === !1) return;
            const {
                deltaX: S,
                deltaY: b,
                event: m
            ...
            const E = m.type.includes("touch"),
                k = m.type.includes("wheel");
            if (this.isTouching = m.type === "touchstart" || m.type === "touchmove", this.options.syncTouch && E && m.type === "touchstart" && !this.isStopped && !this.isLocked) return void this.reset();
            const q = S === 0 && b === 0,
                Y = this.options.gestureOrientation === "vertical" && b === 0 || this.options.gestureOrientation === "horizontal" && S === 0;
            if (q || Y) return;
            let _ = m.composedPath();
            _ = _.slice(0, _.indexOf(this.rootElement));
            const R = this.options.prevent;
            if (_.find(p => {
                    var y, O, T, M, z;
                    return p instanceof Element && (typeof R == "function" && R?.(p) || ((y = p.hasAttribute) === null || y === void 0 ? void 0 : y.call(p, "data-lenis-prevent")) || E && ((O = p.hasAttribute) === null || O === void 0 ? void 0 : O.call(p, "data-lenis-prevent-touch")) || k && ((T = p.hasAttribute) === null || T === void 0 ? void 0 : T.call(p, "data-lenis-prevent-wheel")) || ((M = p.classList) === null || M === void 0 ? void 0 : M.contains("lenis")) && !(!((z = p.classList) === null || z === void 0) && z.contains("lenis-stopped")))
                })) return;
            if (this.isStopped || this.isLocked) return void m.preventDefault();
            if (!(this.options.syncTouch && E || this.options.smoothWheel && k)) return this.isScrolling = "native", void this.animate.stop();
            m.preventDefault();
            let I = b;
            this.options.gestureOrientation === "both" ? I = Math.abs(b) > Math.abs(S) ? b : S : this.options.gestureOrientation === "horizontal" && (I = S);
            const X = E && this.options.syncTouch,
                L = E && m.type === "touchend" && Math.abs(I) > 5;
            ...
            if (clearTimeout(this.__resetVelocityTimeout), delete this.__resetVelocityTimeout, this.__preventNextNativeScrollEvent) delete this.__preventNextNativeScrollEvent;
                ...
                this.animatedScroll = this.targetScroll = this.actualScroll, this.lastVelocity = this.velocity, this.velocity = this.animatedScroll - f, this.direction = Math.sign(this.animatedScroll - f), this.isScrolling = "native", this.emit(), this.velocity !== 0 && (this.__resetVelocityTimeout = setTimeout(() => {
    ...
    scrollTo(t, {
        ...
        if (!this.isStopped && !this.isLocked || c) {
            if (typeof t == "string" && ["top", "left", "start"].includes(t)) t = 0;
                ...
                let v;
                if (typeof t == "string" ? v = document.querySelector(t) : t instanceof HTMLElement && t?.nodeType && (v = t), v) {
                    if (this.options.wrapper !== window) {
                        const w = this.rootElement.getBoundingClientRect();
            ...
            if (typeof t == "number" && (t += e, t = Math.round(t), this.options.infinite ? d && (this.targetScroll = this.animatedScroll = this.scroll) : t = U(0, t, this.limit), t !== this.targetScroll)) {
                if (this.userData = u, s) return this.animatedScroll = this.targetScroll = t, this.setScroll(this.scroll), this.reset(), this.preventNextNativeScrollEvent(), this.emit(), n?.(this), void(this.userData = {});
                d || (this.targetScroll = t), this.animate.fromTo(this.animatedScroll, t, {
                    duration: l,
                    easing: o,
                    lerp: r,
                    onStart: () => {
                    ...
                    onUpdate: (v, g) => {
                        this.isScrolling = "smooth", this.lastVelocity = this.velocity, this.velocity = v - this.animatedScroll, this.direction = Math.sign(this.velocity), this.animatedScroll = v, this.setScroll(this.scroll), d && (this.targetScroll = v), g || this.emit(), g && (this.reset(), this.emit(), n?.(this), this.userData = {}, this.preventNextNativeScrollEvent())
                    }
                })
            }
        }
    ...
    get scroll() {
        return this.options.infinite ? function(e, s) {
            return (e % s + s) % s
...
function C() {
    return C = Object.assign ? Object.assign.bind() : function(h) {
        for (var t = 1; t < arguments.length; t++) {
            var e = arguments[t];
            for (var s in e)({}).hasOwnProperty.call(e, s) && (h[s] = e[s])
        }
        return h
...
class A {
    constructor({
        ...
        this.scrollElements = void 0, this.rootMargin = void 0, this.IORaf = void 0, this.observer = void 0, this.scrollElements = t, this.rootMargin = e, this.IORaf = s, this._init()
    }
    _init() {
        this.observer = new IntersectionObserver(t => {
            t.forEach(e => {
                const s = this.scrollElements.find(i => i.$el === e.target);
                e.isIntersecting ? (s && (s.isAlreadyIntersected = !0), this._setInview(e)) : s && s.isAlreadyIntersected && this._setOutOfView(e)
            })
        }, {
    ...
    _setInview(t) {
        const e = this.scrollElements.find(s => s.$el === t.target);
        this.IORaf && e?.setInteractivityOn(), !this.IORaf && e?.setInview()
    }
    _setOutOfView(t) {
        const e = this.scrollElements.find(s => s.$el === t.target);
        this.IORaf && e?.setInteractivityOff(), !this.IORaf && e?.setOutOfView(), e != null && e.attributes.scrollRepeat || this.IORaf || this.unobserve(t.target)
    }
}

function N(h, t, e, s, i) {
    return e + ((i - h) / (t - h) * (s - e) || 0)
}

function x(h, t) {
    return h.reduce((e, s) => Math.abs(s - t) < Math.abs(e - t) ? s : e)
}
class tt {
    constructor({
        $el: t,
        ...
        unsubscribeElementUpdateFn: l,
        needRaf: o,
        scrollOrientation: r
    }) {
        var a, n, c, d, u;
        this.$el = void 0, this.id = void 0, this.needRaf = void 0, this.attributes = void 0, this.scrollOrientation = void 0, this.isAlreadyIntersected = void 0, this.intersection = void 0, this.metrics = void 0, this.currentScroll = void 0, this.translateValue = void 0, this.progress = void 0, this.lastProgress = void 0, this.modularInstance = void 0, this.progressModularModules = void 0, this.isInview = void 0, this.isInteractive = void 0, this.isInFold = void 0, this.isFirstResize = void 0, this.subscribeElementUpdateFn = void 0, this.unsubscribeElementUpdateFn = void 0, this.$el = t, this.id = e, this.needRaf = o, this.scrollOrientation = r, this.modularInstance = s, this.subscribeElementUpdateFn = i, this.unsubscribeElementUpdateFn = l, this.attributes = {
            scrollClass: (a = this.$el.dataset.scrollClass) != null ? a : "is-inview",
            scrollOffset: (n = this.$el.dataset.scrollOffset) != null ? n : "0,0",
            ...
            scrollCall: (u = this.$el.dataset.scrollCall) != null ? u : null,
    ...
    onRender({
        ...
        const s = this.scrollOrientation === "vertical" ? window.innerHeight : window.innerWidth;
        if (this.currentScroll = t, this._computeProgress(), this.attributes.scrollSpeed && !isNaN(this.attributes.scrollSpeed))
            if (this.attributes.scrollEnableTouchSpeed || e) {
                if (this.isInFold) {
                    ...
                    const i = N(0, 1, -1, 1, this.progress);
                    this.translateValue = i * s * this.attributes.scrollSpeed * -1
                }
    ...
    setInteractivityOff() {
        this.isInteractive && (this.isInteractive = !1, this.unsubscribeElementUpdateFn(this), this.lastProgress != null && this._computeProgress(x([0, 1], this.lastProgress)))
    }
    _resize() {
    ...
    _computeMetrics() {
        const {
            ...
            height: s,
            width: i
        } = this.metrics.bcr, l = this.scrollOrientation === "vertical" ? window.innerHeight : window.innerWidth, o = this.scrollOrientation === "vertical" ? s : i;
        this.metrics.offsetStart = this.currentScroll + (this.scrollOrientation === "vertical" ? t : e) - this.translateValue, this.metrics.offsetEnd = this.metrics.offsetStart + o, this.isInFold = this.metrics.offsetStart < l && !this.attributes.scrollIgnoreFold
    }
    _computeIntersection() {
        const t = this.scrollOrientation === "vertical" ? window.innerHeight : window.innerWidth,
            ...
            i = s[0] != null ? s[0].trim() : "0",
            l = s[1] != null ? s[1].trim() : "0",
            o = this.attributes.scrollPosition.split(",");
        let r = o[0] != null ? o[0].trim() : "start";
        const a = o[1] != null ? o[1].trim() : "end",
            n = i.includes("%") ? t * parseInt(i.replace("%", "").trim()) * .01 : parseInt(i),
            c = l.includes("%") ? t * parseInt(l.replace("%", "").trim()) * .01 : parseInt(l);
        switch (this.isInFold && (r = "fold"), r) {
            case "start":
            default:
                this.intersection.start = this.metrics.offsetStart - t + n;
                break;
            case "middle":
                this.intersection.start = this.metrics.offsetStart - t + n + .5 * e;
                break;
            case "end":
                this.intersection.start = this.metrics.offsetStart - t + n + e;
                break;
            case "fold":
    ...
    _computeProgress(t) {
        const e = t ?? ((s = N(this.intersection.start, this.intersection.end, 0, 1, this.currentScroll)) < 0 ? 0 : s > 1 ? 1 : s);
        var s;
        if (this.progress = e, e != this.lastProgress) {
            if (this.lastProgress = e, this.attributes.scrollCssProgress && this._setCssProgress(e), this.attributes.scrollEventProgress && this._setCustomEventProgress(e), this.attributes.scrollModuleProgress)
                for (const i of this.progressModularModules) this.modularInstance && this.modularInstance.call("onScrollProgress", e, i.moduleName, i.moduleId);
    ...
    _getProgressModularModules() {
        ...
        const t = Object.keys(this.$el.dataset).filter(s => s.includes("module")),
            e = Object.entries(this.modularInstance.modules);
        if (t.length)
            for (const s of t) {
                const i = this.$el.dataset[s];
                if (!i) return;
                for (const l of e) {
                    const [o, r] = l;
                    i in r && this.progressModularModules.push({
                        moduleName: o,
                        moduleId: i
                    })
                }
    ...
    _getScrollCallFrom() {
        const t = x([this.intersection.start, this.intersection.end], this.currentScroll);
        return this.intersection.start === t ? "start" : "end"
    }
    _dispatchCall(t, e) {
        var s, i;
        const l = (s = this.attributes.scrollCall) == null ? void 0 : s.split(","),
            o = (i = this.attributes) == null ? void 0 : i.scrollCallSelf;
        if (l && l.length > 1) {
            var r;
            const [a, n, c] = l;
            let d;
            d = o ? this.$el.dataset[`module${n.trim()}`] : c, this.modularInstance && this.modularInstance.call(a.trim(), {
                target: this.$el,
                way: t,
                from: e
            }, n.trim(), (r = d) == null ? void 0 : r.trim())
        } else if (l) {
            const [a] = l, n = new CustomEvent(a, {
                detail: {
                    target: this.$el,
                    way: t,
                    from: e
...
const et = ["scrollOffset", "scrollPosition", "scrollModuleProgress", "scrollCssProgress", "scrollEventProgress", "scrollSpeed"];
class st {
    constructor({
        $el: t,
        modularInstance: e,
        ...
        this.$scrollContainer = void 0, this.modularInstance = void 0, this.triggerRootMargin = void 0, this.rafRootMargin = void 0, this.scrollElements = void 0, this.triggeredScrollElements = void 0, this.RAFScrollElements = void 0, this.scrollElementsToUpdate = void 0, this.IOTriggerInstance = void 0, this.IORafInstance = void 0, this.scrollOrientation = void 0, t && (this.$scrollContainer = t, this.modularInstance = e, this.scrollOrientation = l, this.triggerRootMargin = s ?? "-1px -1px -1px -1px", this.rafRootMargin = i ?? "100% 100% 100% 100%", this.scrollElements = [], this.triggeredScrollElements = [], this.RAFScrollElements = [], this.scrollElementsToUpdate = [], this._init())
    }
    _init() {
        const t = this.$scrollContainer.querySelectorAll("[data-scroll]"),
            e = Array.from(t);
        this._subscribeScrollElements(e), this.IOTriggerInstance = new A({
            scrollElements: [...this.triggeredScrollElements],
            rootMargin: this.triggerRootMargin,
            IORaf: !1
        }), this.IORafInstance = new A({
    ...
    onRender({
        ...
        for (const s of this.scrollElementsToUpdate) s.onRender({
            currentScroll: t,
            smooth: e
        })
    }
    removeScrollElements(t) {
        ...
        if (e.length) {
            for (let s = 0; s < this.triggeredScrollElements.length; s++) {
                const i = this.triggeredScrollElements[s];
                Array.from(e).indexOf(i.$el) > -1 && (this.IOTriggerInstance.unobserve(i.$el), this.triggeredScrollElements.splice(s, 1))
            }
            for (let s = 0; s < this.RAFScrollElements.length; s++) {
                const i = this.RAFScrollElements[s];
                Array.from(e).indexOf(i.$el) > -1 && (this.IORafInstance.unobserve(i.$el), this.RAFScrollElements.splice(s, 1))
            }
            e.forEach(s => {
                const i = this.scrollElementsToUpdate.find(o => o.$el === s),
                    l = this.scrollElements.find(o => o.$el === s);
                i && this._unsubscribeElementUpdate(i), l && (this.scrollElements = this.scrollElements.filter(o => o.id != l.id))
            })
        }
    }
    addScrollElements(t) {
        ...
        const i = Math.max(...s, 0) + 1,
            l = Array.from(e);
        this._subscribeScrollElements(l, i, !0)
    }
    _subscribeScrollElements(t, e = 0, s = !1) {
        for (let i = 0; i < t.length; i++) {
            const l = t[i],
                o = this._checkRafNeeded(l),
                r = new tt({
                    $el: l,
                    id: e + i,
            ...
            this.scrollElements.push(r), o ? (this.RAFScrollElements.push(r), s && (this.IORafInstance.scrollElements.push(r), this.IORafInstance.observe(r.$el))) : (this.triggeredScrollElements.push(r), s && (this.IOTriggerInstance.scrollElements.push(r), this.IOTriggerInstance.observe(r.$el)))
        }
    }
    ...
    _checkRafNeeded(t) {
        ...
        if (t.dataset.scrollOffset) {
            if (t.dataset.scrollOffset.split(",").map(i => i.replace("%", "").trim()).join(",") != "0,0") return !0;
            s("scrollOffset")
        } else s("scrollOffset");
...
class lt {
    constructor({
        ...
        for (const [c] of Object.entries(t))["wrapper", "content", "infinite"].includes(c);
        Object.assign(this, {
            lenisOptions: t,
            modularInstance: e,
            triggerRootMargin: s,
    ...
    _init() {
        var t;
        this.lenisInstance = new Z(C({}, this.lenisOptions, {
            wrapper: window,
            ...
            this.coreInstance = new st({
                $el: this.lenisInstance.rootElement,
                modularInstance: this.modularInstance,
                triggerRootMargin: this.triggerRootMargin,
                rafRootMargin: this.rafRootMargin,
                scrollOrientation: this.lenisInstance.options.orientation
            }), this._bindEvents(), this.initCustomTicker && !this.destroyCustomTicker || !this.initCustomTicker && this.destroyCustomTicker, this.autoStart && this.start()
        })
    }
    destroy() {
        var t;
    ...
    _bindEvents() {
        this._bindScrollToEvents(), this.autoResize && ("ResizeObserver" in window ? this.ROInstance = new it({
    ...
    _bindScrollToEvents(t) {
        const e = t || this.lenisInstance.rootElement,
            s = e?.querySelectorAll("[data-scroll-to]");
    ...
    _onScrollTo(t) {
        var e;
        t.preventDefault();
        const s = (e = t.currentTarget) != null ? e : null;
        if (!s) return;
        const i = s.getAttribute("data-scroll-to-href") || s.getAttribute("href"),
            l = s.getAttribute("data-scroll-to-offset") || 0,
            o = s.getAttribute("data-scroll-to-duration") || this.lenisInstance.options.duration;
        i && this.scrollTo(i, {
            offset: typeof l == "string" ? parseInt(l) : l,
    ...
    removeScrollElements(t) {
        var e;
        t && (this._unbindScrollToEvents(t), (e = this.coreInstance) == null || e.removeScrollElements(t))
    }
    addScrollElements(t) {
        var e;
    ...
    scrollTo(t, e) {
        var s;
        (s = this.lenisInstance) == null || s.scrollTo(t, {
            offset: e?.offset,
            lerp: e?.lerp,
            duration: e?.duration,
        ...
        this.locomotiveScroll = new lt({
            scrollCallback({
                ...
                K.set({
                    ...
                    direction: i,
                    progress: l
                }), i < 0 ? document.documentElement.classList.add("is-scrolling-up") : document.documentElement.classList.remove("is-scrolling-up"), t > 10 ? document.documentElement.classList.add("has-scrolled") : document.documentElement.classList.remove("has-scrolled")
            }
        })
    }
    static destroy() {
