...
var H = ["sitekey", "onChange", "theme", "type", "tabindex", "onExpired", "onErrored", "size", "stoken", "grecaptcha", "badge", "hl", "isolated"];
...
function z(r, n) {
    ...
    var i = {},
        t = Object.keys(r),
        e, c;
    for (c = 0; c < t.length; c++) e = t[c], !(n.indexOf(e) >= 0) && (i[e] = r[e]);
    return i
}
...
var L = function(r) {
    ...
    function n() {
        var t;
        return t = r.call(this) || this, t.handleExpired = t.handleExpired.bind(x(t)), t.handleErrored = t.handleErrored.bind(x(t)), t.handleChange = t.handleChange.bind(x(t)), t.handleRecaptchaRef = t.handleRecaptchaRef.bind(x(t)), t
    }
    var i = n.prototype;
    return i.getCaptchaFunction = function(e) {
        ...
        var e = this.props;
        e.sitekey, e.onChange, e.theme, e.type, e.tabindex, e.onExpired, e.onErrored, e.size, e.stoken, e.grecaptcha, e.badge, e.hl, e.isolated;
        var c = z(e, H);
        return v.createElement("div", E({}, c, {
        ...
        function(t) {
            var e = t.displayName || t.name || "Component",
                c = function(R) {
                    ...
                    function y(f, a) {
                        var o;
                        return o = R.call(this, f, a) || this, o.state = {}, o.__scriptURL = "", o
                    }
                    var l = y.prototype;
                    return l.asyncScriptLoaderGetScriptLoaderID = function() {
                        return this.__scriptLoaderID || (this.__scriptLoaderID = "async-script-loader-" + $++), this.__scriptLoaderID
                    }, l.setupScriptURL = function() {
                        return this.__scriptURL = typeof r == "function" ? r() : r, this.__scriptURL
                    }, l.asyncScriptLoaderHandleLoad = function(a) {
                        var o = this;
                        this.setState(a, function() {
                            return o.props.asyncScriptOnLoad && o.props.asyncScriptOnLoad(o.state)
                        })
                        ...
                        w && typeof window < "u" && (window[w] = function() {
                            ...
                            var d = h[o];
                            d && (d.loaded = !0, U(function(_) {
                                return w ? !1 : (_(d), !0)
                            }))
                        }, g.onerror = function() {
                            var d = h[o];
                            d && (d.errored = !0, U(function(_) {
                                return _(d), !0
                            }))
                        ...
                        if (n.removeOnUnmount === !0)
                            for (var o = document.getElementsByTagName("script"), p = 0; p < o.length; p += 1) o[p].src.indexOf(a) > -1 && o[p].parentNode && o[p].parentNode.removeChild(o[p]);
                        var u = h[a];
                        u && (delete u.observers[this.asyncScriptLoaderGetScriptLoaderID()], n.removeOnUnmount === !0 && delete h[a])
                    }, l.render = function() {
                        var a = n.globalName,
                            o = this.props;
                        o.asyncScriptOnLoad;
                        var p = o.forwardedRef,
                            u = q(o, ["asyncScriptOnLoad", "forwardedRef"]);
                        return a && typeof window < "u" && (u[a] = typeof window[a] < "u" ? window[a] : void 0), u.ref = p, v.createElement(t, u)
                    }, y
                }(v.Component),
                m = v.forwardRef(function(R, y) {
                    return v.createElement(c, I({}, R, {
                        forwardedRef: y
                    }))
                });
            return m.displayName = "AsyncScriptLoader(" + e + ")", m.propTypes = {
...
function B() {
    ...
    return r.enterprise ? "https://" + n + "/recaptcha/enterprise.js?onload=" + C + "&render=explicit" : "https://" + n + "/recaptcha/api.js?onload=" + C + "&render=explicit"
}
const X = M(B, {
    callbackName: C,
    globalName: V,
