...
function me(i) {
    ...
    const l = e > r ? "next" : "prev",
        c = (u, p) => l === "next" && u >= p || l === "prev" && u <= p,
        f = () => {
            o = new Date().getTime(), a === null && (a = o);
            const u = Math.max(Math.min((o - a) / d, 1), 0),
                p = .5 - Math.cos(u * Math.PI) / 2;
            let m = r + p * (e - r);
            if (c(m, e) && (m = e), t.wrapperEl.scrollTo({
                    [s]: m
                }), c(m, e)) {
...
function jt(i) {
    return t => Math.abs(t) > 0 && i.browser && i.browser.need3dFix && Math.abs(t) % 90 === 0 ? t + .001 : t
}
let X;
...
function ke(i) {
    ...
    return !c && m && e.touch && w.indexOf(`${o}x${d}`) >= 0 && (c = r.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), m = !1), l && !p && (a.os = "android", a.android = !0), (c || u || f) && (a.os = "ios", a.ios = !0), a
}
...
function Ne() {
    ...
    const e = i.params,
        ...
        d = i.virtual && e.virtual.enabled,
        l = d ? i.virtual.slides.length : i.slides.length,
        c = B(n, `.${i.params.slideClass}, swiper-slide`),
            ...
            if (e.slidesPerView === "auto") {
                ...
                if (L && (x.style.transform = "none"), F && (x.style.webkitTransform = "none"), e.roundLengths) y = i.isHorizontal() ? ae(x, "width") : ae(x, "height");
                    ...
                    const _ = t(P, "width"),
                        ...
                        G = t(P, "margin-left"),
                        D = t(P, "margin-right"),
                        re = P.getPropertyValue("box-sizing");
    ...
    if (d && e.loop) {
        ...
        if (e.slidesPerGroup > 1) {
            const x = Math.ceil((i.virtual.slidesBefore + i.virtual.slidesAfter) / e.slidesPerGroup),
    ...
    if (u.length === 0 && (u = [0]), h !== 0) {
        ...
        c.filter((x, P) => !e.cssMode || e.loop ? !0 : P !== c.length - 1).forEach(x => {
            x.style[v] = `${h}px`
        })
    }
    ...
    if (f !== l && i.emit("slidesLengthChange"), u.length !== g && (i.params.watchOverflow && i.checkOverflow(), i.emit("snapGridLengthChange")), p.length !== S && i.emit("slidesGridLengthChange"), e.watchSlidesProgress && i.updateSlidesOffset(), i.emit("slidesUpdated"), !d && !e.cssMode && (e.effect === "slide" || e.effect === "fade")) {
        const v = `${e.containerModifierClass}backface-hidden`,
            x = i.el.classList.contains(v);
...
function $e() {
    const i = this,
        t = i.slides,
        e = i.isElement ? i.isHorizontal() ? i.wrapperEl.offsetLeft : i.wrapperEl.offsetTop : 0;
...
function He(i) {
    ...
    for (let d = 0; d < s.length; d += 1) {
        ...
        const f = (a + (e.centeredSlides ? t.minTranslate() : 0) - c) / (l.swiperSlideSize + o),
            u = (a - r[0] + (e.centeredSlides ? t.minTranslate() : 0) - c) / (l.swiperSlideSize + o),
            p = -(a - c),
            m = p + t.slidesSizesGrid[d],
            w = p >= 0 && p <= t.size - t.slidesSizesGrid[d],
            E = p >= 0 && p < t.size - 1 || m > 1 && m <= t.size || p <= 0 && m >= t.size;
...
function We(i) {
    ...
    Object.assign(t, {
        ...
        isBeginning: r,
        isEnd: a
    }), (e.watchSlidesProgress || e.centeredSlides && e.autoHeight) && t.updateSlidesProgress(i), r && !d && t.emit("reachBeginning toEdge"), a && !l && t.emit("reachEnd toEdge"), (d && !r || l && !a) && t.emit("fromEdge"), t.emit("progress", n)
}
const U = (i, t, e) => {
    t && !i.classList.contains(e) ? i.classList.add(e) : !t && i.classList.contains(e) && i.classList.remove(e)
};
...
function je() {
    const i = this,
        ...
        o = f => B(s, `.${e.slideClass}${f}, swiper-slide${f}`)[0];
    let d, l, c;
    if (r)
        if (e.loop) {
...
const W = (i, t) => {
    ...
    ie = i => {
        ...
        if (i.params.grid && i.params.grid.rows > 1) {
            ...
            o.push(...Array.from({
                length: t
            }).map((d, l) => a + s + l)), i.slides.forEach((d, l) => {
        ...
        if (i.params.rewind || i.params.loop)
            for (let a = n - t; a <= r + t; a += 1) {
                ...
                for (let a = Math.max(n - t, 0); a <= Math.min(r + t, e - 1); a += 1) a !== n && (a > r || a < n) && Q(i, a)
    };
...
function Xe(i) {
    ...
    Object.assign(t, {
        ...
        previousIndex: r,
        activeIndex: d
    }), t.initialized && ie(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (a !== u && t.emit("realIndexChange"), t.emit("slideChange"))
}
...
function st(i, t) {
    ...
    s.cssMode || (s.autoHeight && e.updateAutoHeight(), we({
        swiper: e,
        runCallbacks: i,
        direction: t,
        step: "Start"
...
function rt(i, t) {
    ...
    e.animating = !1, !s.cssMode && (e.setTransition(0), we({
        swiper: e,
        runCallbacks: i,
        direction: t,
        step: "End"
...
function ot(i, t, e, s, n) {
    ...
    if (!m && !s && !n || r.destroyed || r.animating && o.preventInteractionOnTransition) return !1;
    ...
    if (o.normalizeSlideIndex)
        for (let I = 0; I < l.length; I += 1) {
            const y = -Math.floor(g * 100),
                A = Math.floor(l[I] * 100),
                v = Math.floor(l[I + 1] * 100);
            typeof l[I + 1] < "u" ? y >= A && y < v - (v - A) / 2 ? a = I : y >= A && y < v && (a = I + 1) : y >= A && (a = I)
        }
    if (r.initialized && a !== f && (!r.allowSlideNext && (u ? g > r.translate && g > r.minTranslate() : g < r.translate && g < r.minTranslate()) || !r.allowSlidePrev && g > r.translate && g > r.maxTranslate() && (f || 0) !== a)) return !1;
    ...
    if (!(h && n) && (u && -g === r.translate || !u && g === r.translate)) return r.updateActiveIndex(a), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), o.effect !== "slide" && r.setTranslate(g), S !== "reset" && (r.transitionStart(e, S), r.transitionEnd(e, S)), !1;
    if (o.cssMode) {
        const I = r.isHorizontal(),
            y = u ? g : -g;
        if (t === 0) h && (r.wrapperEl.style.scrollSnapType = "none", r._immediateVirtual = !0), h && !r._cssModeVirtualInitialSet && r.params.initialSlide > 0 ? (r._cssModeVirtualInitialSet = !0, requestAnimationFrame(() => {
    ...
    const C = ve().isSafari;
    return h && !n && C && r.isElement && r.virtual.update(!1, !1, a), r.setTransition(t), r.setTranslate(g), r.updateActiveIndex(a), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, s), r.transitionStart(e, S), t === 0 ? r.transitionEnd(e, S) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function(y) {
...
function at(i, t, e, s) {
    ...
    if (n.params.loop)
        if (n.virtual && n.params.virtual.enabled) a = a + n.virtual.slidesBefore;
            ...
            let f = d - o < c;
            if (l && (f = f || o < Math.ceil(c / 2)), s && l && n.params.slidesPerView !== "auto" && !r && (f = !1), f) {
                const u = l ? o < n.activeIndex ? "prev" : "next" : o - n.activeIndex - 1 < n.params.slidesPerView ? "next" : "prev";
                n.loopFix({
                    direction: u,
                    slideTo: !0,
                    activeSlideIndex: u === "next" ? o + 1 : o - d + 1,
...
function lt(i, t, e) {
    ...
    const d = s.activeIndex < r.slidesPerGroupSkip ? 1 : o,
        l = s.virtual && r.virtual.enabled;
    if (r.loop) {
        if (a && !l && r.loopPreventsSliding) return !1;
        if (s.loopFix({
                direction: "next"
...
function ft(i, t, e, s) {
    ...
    if (d >= n.snapGrid[o]) {
        const l = n.snapGrid[o],
            c = n.snapGrid[o + 1];
        d - l > (c - l) * s && (r += n.params.slidesPerGroup)
    } else {
        const l = n.snapGrid[o - 1],
            c = n.snapGrid[o];
        d - l <= (c - l) * s && (r -= n.params.slidesPerGroup)
    }
...
function mt(i, t) {
    ...
    const r = () => {
        ...
        l = a && e.slides.length % s.grid.rows !== 0,
        c = f => {
            for (let u = 0; u < f; u += 1) {
...
function ht(i) {
    ...
    if (l.allowSlidePrev = !0, l.allowSlideNext = !0, l.virtual && m.virtual.enabled) {
        e && (!m.centeredSlides && l.snapIndex === 0 ? l.slideTo(l.virtual.slides.length, 0, !1, !0) : m.centeredSlides && l.snapIndex < m.slidesPerView ? l.slideTo(l.virtual.slides.length + l.snapIndex, 0, !1, !0) : l.snapIndex === l.snapGrid.length - 1 && l.slideTo(l.virtual.slidesBefore, 0, !1, !0)), l.allowSlidePrev = f, l.allowSlideNext = u, l.emit("loopFix");
        return
    }
    ...
    const T = [],
        C = [],
        I = b ? Math.ceil(c.length / m.grid.rows) : c.length,
        y = a && I - E < g && !w;
    ...
    let P = 0,
        L = 0;
    const _ = (b ? c[r].column : r) + (w && typeof n > "u" ? -g / 2 + .5 : 0);
    if (_ < h) {
        P = Math.max(h - _, S);
    ...
    if (l.__preventObserver__ = !0, requestAnimationFrame(() => {
            ...
            c[M].swiperLoopMoveDOM = !0, p.prepend(c[M]), c[M].swiperLoopMoveDOM = !1
        }), v && C.forEach(M => {
            c[M].swiperLoopMoveDOM = !0, p.append(c[M]), c[M].swiperLoopMoveDOM = !1
        ...
        if (T.length > 0 && x) {
            if (typeof t > "u") {
                const M = l.slidesGrid[A],
                    G = l.slidesGrid[A + P] - M;
                d ? l.setTranslate(l.translate - G) : (l.slideTo(A + Math.ceil(P), 0, !1, !0), n && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - G, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - G))
            } else if (n) {
            ...
            if (typeof t > "u") {
                const M = l.slidesGrid[A],
                    G = l.slidesGrid[A - L] - M;
                d ? l.setTranslate(l.translate - G) : (l.slideTo(A - L, 0, !1, !0), n && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - G, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - G))
            } else {
    ...
    if (l.allowSlidePrev = f, l.allowSlideNext = u, l.controller && l.controller.control && !o) {
        ...
        Array.isArray(l.controller.control) ? l.controller.control.forEach(O => {
            !O.destroyed && O.params.loop && O.loopFix({
                ...M,
                slideTo: O.params.slidesPerView === m.slidesPerView ? e : !1
            })
        }) : l.controller.control instanceof l.constructor && l.controller.control.params.loop && l.controller.control.loopFix({
            ...M,
            slideTo: l.controller.control.params.slidesPerView === m.slidesPerView ? e : !1
        })
    }
    l.emit("loopFix")
}
...
function bt(i) {
    ...
    Object.assign(n, {
        ...
        isScrolling: void 0,
        startMoving: void 0
    }), a.startX = p, a.startY = m, n.touchStartTime = j(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1);
    let w = !0;
...
function yt(i) {
    ...
    let m = e.isHorizontal() ? u : p,
        w = e.isHorizontal() ? r.currentX - r.previousX : r.currentY - r.previousY;
    ...
    const g = e.params.loop && !n.cssMode,
    ...
    if (new Date().getTime(), n._loopSwapReset !== !1 && s.isMoved && s.allowThresholdMove && E !== e.touchesDirection && g && S && Math.abs(m) >= 1) {
        Object.assign(r, {
            startX: c,
            startY: f,
            currentX: c,
    ...
    e.emit("sliderMove", d), s.isMoved = !0, s.currentTranslate = m + s.startTranslate;
    let h = !0,
        b = n.resistanceRatio;
    if (n.touchReleaseOnEdges && (b = 0), m > 0 ? (g && S && s.allowThresholdMove && s.currentTranslate > (n.centeredSlides ? e.minTranslate() - e.slidesSizesGrid[e.activeIndex + 1] - (n.slidesPerView !== "auto" && e.slides.length - n.slidesPerView >= 2 ? e.slidesSizesGrid[e.activeIndex + 1] + e.params.spaceBetween : 0) - e.params.spaceBetween : e.minTranslate()) && e.loopFix({
            ...
            setTranslate: !0,
            activeSlideIndex: 0
        }), s.currentTranslate > e.minTranslate() && (h = !1, n.resistance && (s.currentTranslate = e.minTranslate() - 1 + (-e.minTranslate() + s.startTranslate + m) ** b))) : m < 0 && (g && S && s.allowThresholdMove && s.currentTranslate < (n.centeredSlides ? e.maxTranslate() + e.slidesSizesGrid[e.slidesSizesGrid.length - 1] + e.params.spaceBetween + (n.slidesPerView !== "auto" && e.slides.length - n.slidesPerView >= 2 ? e.slidesSizesGrid[e.slidesSizesGrid.length - 1] + e.params.spaceBetween : 0) : e.maxTranslate()) && e.loopFix({
            direction: "next",
            setTranslate: !0,
            activeSlideIndex: e.slides.length - (n.slidesPerView === "auto" ? e.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10)))
        }), s.currentTranslate < e.maxTranslate() && (h = !1, n.resistance && (s.currentTranslate = e.maxTranslate() + 1 - (e.maxTranslate() - s.startTranslate - m) ** b))), h && (d.preventedByNestedSwiper = !0), !e.allowSlideNext && e.swipeDirection === "next" && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !e.allowSlidePrev && e.swipeDirection === "prev" && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), !e.allowSlidePrev && !e.allowSlideNext && (s.currentTranslate = s.startTranslate), n.threshold > 0)
...
const Se = (i, t) => {
    ...
    !n || typeof n == "string" || (e[d]("touchstart", i.onDocumentTouchStart, {
        ...
        passive: !0
    }), (s.preventClicks || s.preventClicksPropagation) && n[d]("click", i.onClick, !0), s.cssMode && r[d]("scroll", i.onScroll), s.updateOnWindowResize ? i[l](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", ce, !0) : i[l]("observerUpdate", ce, !0), n[d]("load", i.onLoad, {
        capture: !0
    }))
};
...
function At() {
    ...
    const a = R(),
        o = s.breakpointsBase === "window" || !s.breakpointsBase ? s.breakpointsBase : "container",
        d = ["window", "container"].includes(s.breakpointsBase) || !s.breakpointsBase ? i.el : a.querySelector(s.breakpointsBase),
    ...
    const g = f.direction && f.direction !== s.direction,
        S = s.loop && (f.slidesPerView !== s.slidesPerView || g),
        h = s.loop;
    ...
    }), E && !b ? i.disable() : !E && b && i.enable(), i.currentBreakpoint = l, i.emit("_beforeBreakpoint", f), e && (S ? (i.loopDestroy(), i.loopCreate(t), i.updateSlides()) : !h && T ? (i.loopCreate(t), i.updateSlides()) : h && !T && i.loopDestroy()), i.emit("breakpoint", f)
}
...
class V {
    constructor() {
        ...
        const o = this;
        o.__swiper__ = !0, o.support = he(), o.device = ge({
            userAgent: e.userAgent
        }), o.browser = ve(), o.eventsListeners = {}, o.eventsAnyListeners = [], o.modules = [...o.__modules__], e.modules && Array.isArray(e.modules) && o.modules.push(...e.modules);
        const d = {};
        o.modules.forEach(c => {
            c({
                params: e,
    ...
    getSlideIndex(t) {
        const {
            slidesEl: e,
            params: s
        } = this, n = B(e, `.${s.slideClass}, swiper-slide`), r = oe(n[0]);
        return oe(t) - r
    }
    ...
    slidesPerViewDynamic(t, e) {
        ...
        if (n.centeredSlides) {
            let f = r[l] ? Math.ceil(r[l].swiperSlideSize) : 0,
                u;
            for (let p = l + 1; p < r.length; p += 1) r[p] && !u && (f += Math.ceil(r[p].swiperSlideSize), c += 1, f > d && (u = !0));
            for (let p = l - 1; p >= 0; p -= 1) r[p] && !u && (f += r[p].swiperSlideSize, c += 1, f > d && (u = !0))
        } else if (t === "current")
            for (let f = l + 1; f < r.length; f += 1)(e ? a[f] + o[f] - a[l] < d : a[f] - a[l] < d) && (c += 1);
        else
            for (let f = l - 1; f >= 0; f -= 1) a[l] - a[f] < d && (c += 1);
        return c
    }
    update() {
        const t = this;
    ...
    init(t) {
        ...
        }), ie(e), e.initialized = !0, ie(e), e.emit("init"), e.emit("afterInit"), e
    }
    destroy(t, e) {
        ...
        return typeof s.params > "u" || s.destroyed || (s.emit("beforeDestroy"), s.initialized = !1, s.detachEvents(), n.loop && s.loopDestroy(), e && (s.removeClasses(), r && typeof r != "string" && r.removeAttribute("style"), a && a.removeAttribute("style"), o && o.length && o.forEach(d => {
            ...
            s.off(d)
        }), t !== !1 && (s.el && typeof s.el != "string" && (s.el.swiper = null), Ee(s)), s.destroyed = !0), null
    }
...
V.use([De, Be]);
export {
    V as S, z as a, Ht as b, B as c, te as d, Ae as e, ue as f, R as g, ae as h, oe as i, $ as j, $t as k, jt as l, Wt as m
};